...
public class ImageRunner extends GraphicsProgram {
    ...
    private Images algorithms;

    public void init() {
        addButtons();
        addActionListeners();
        setTitle("AP CS");
        algorithms = new Images();
    }
    ...
    private void addButtons() {
        ...
        infoLabel = new JLabel("Welcome to AP CS Images at Cypress Ranch!");
        add(infoLabel, NORTH);
